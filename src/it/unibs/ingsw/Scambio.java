...
public class Scambio implements Serializable {
     ...
     * @param app  applicazione
     */
    private void manageExchange(@NotNull View view, @NotNull Applicazione app, Fruitore f) throws IOException {
     ...
     */
    private @NotNull String getLastMsgString(Fruitore f) {
