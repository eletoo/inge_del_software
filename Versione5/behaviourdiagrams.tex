...
\begin{figure}[h]
\centering
\includegraphics[width=16cm,scale=2.0]{imagesV5/state diagram configuratore.png}
...
\begin{figure}[!]
\centering
\includegraphics[width=16cm,height=5.5cm]{imagesV5/state diagram fruitore.png}
