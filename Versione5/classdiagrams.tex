...
\begin{figure}[h!]
    \centering
    \includegraphics[width=16cm]{imagesV5/diagramma classi.png}
...
La classe contiene anche dei metodi che permettono l'introduzione di informazioni dal \textit{back-end} tramite file preesistenti. 
...
\begin{figure}[!]
    \centering
    \includegraphics[width=16cm]{imagesV5/partial class diagram.png}
