...
Nella Tabella \ref{tab:Use Case 4.15} è riportato il caso d'uso testuale relativo alla visualizzazione da parte di un utente configuratore delle proprie offerte di baratto relative ad una categoria selezionata il cui stato è \textit{Chiusa}.\bigskip
