...
\begin{figure}[h!]
    \centering
    \includegraphics[width=16cm]{imagesV4/Class diagram.png}
...
La classe \texttt{Applicazione} permette di tenere traccia delle gerarchie contenute nell'applicazione, delle informazioni di scambio, delle offerte inserite dagli utenti e degli scambi da essi proposti. 
...
Inoltre contiene i metodi necessari a leggere da file e salvare su file le informazioni di scambio, le offerte contenute nell'applicazione e gli scambi proposti dagli utenti. 
...
\begin{figure}[!]
    \centering
    \includegraphics[width=16cm]{imagesV4/Partial class diagram.png}
