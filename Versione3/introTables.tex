...
Nella Tabella \ref{tab:Use Case 3.11} è riportato il caso d'uso testuale relativo al ritiro di un'offerta da parte del fruitore: l'utente può scegliere un'offerta aperta tra le proprie e modificarne lo stato ritirandola.\bigskip
...
Nella Tabella \ref{tab:Use Case 3.13} è riportato il caso d'uso testuale relativo alla visualizzazione delle offerte aperte relative ad una specifica categoria foglia da parte di un qualsiasi utente (sia fruitore che configuratore).\bigskip
