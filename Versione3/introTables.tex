...
Nella Tabella \ref{tab:Use Case 3.12} è riportato il caso d'uso testuale relativo alla creazione di una offerta da parte del fruitore: l'utente dovrà interagire con il sistema compilando i campi necessari per la corretta creazione della suddetta offerta.\bigskip
