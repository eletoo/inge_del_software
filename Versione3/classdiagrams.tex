...
\begin{figure}[h!]
    \centering
    \includegraphics[width=16cm]{imagesV3/Class Diagram - Versione 3.png}
    \caption{\label{fig:Class Diagram}Diagramma UML delle classi - Versione 3}
\end{figure} 
...
\begin{figure}[bh]
    \centering
    \includegraphics[width=16cm]{imagesV3/Vers3Parziale.png}
    \caption{\label{fig:Simplified Class Diagram}Diagramma UML delle classi semplificato - Versione 3}
\end{figure}
\bigskip