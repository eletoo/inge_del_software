...
\begin{figure}[h!]
    \centering
    \includegraphics[width=\textwidth]{imagesV2/Class diagram-Version2.0.png}
...
Inoltre contiene i metodi necessari a leggere da file e salvare su file le informazioni di scambio contenute nell'applicazione. 
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=\textwidth]{imagesV2/Partial class diagram-Version2.0.png}
